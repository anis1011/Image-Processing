...
def calibrate_gauge(img):
    ...
    cv2.imwrite('images/logs/gray_masked_image.jpg', gray)
    ...
    cv2.imwrite('images/logs/calibration.jpg', img)
...
def get_current_value(img, min_angle, max_angle, min_value, max_value, x, y, r):
    ...
    cv2.imwrite('images/logs/threshhold.jpg', dst2)
    ...
    #    for x1, y1, x2, y2 in lines[i]:
     #       cv2.line(img, (x1, y1), (x2, y2), (0, 255, 0), 2)
      #      cv2.imwrite('images/logs/gauge_all_lines.jpg', img)
   ...
   # testing only, show all lines after filtering
    ...
    cv2.imwrite('images/logs/line_overlay.jpg', img)
...
def main():
    ...
    inputFolder = os.getcwd() + "/images/input/*.jpg"
    ...
    if (len(inputImages) > 0):
        for path in inputImages:
            ...
            cv2.imwrite('images/logs/cropImg.jpg',img)        

            # Gauge circle calibration
            img = cv2.imread('images/logs/cropImg.jpg')
